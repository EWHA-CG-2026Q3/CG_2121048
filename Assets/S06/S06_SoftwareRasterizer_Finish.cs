...
public class S06_SoftwareRasterizer_Finish : MonoBehaviour
{
    ...
    [SerializeField] private Vector2 vertexB = new Vector2(65, 40);
    [SerializeField] private Vector2 vertexC = new Vector2(230, 100);
    [SerializeField] private Color fillColor = new Color(0.2f, 0.8f, 1f, 1f);
    [SerializeField] private Color backgroundColor = new Color(1f, 0.9f, 0.2f, 1f);
